...
void demo_imgui()
{
    ...
    static const char* effect_names[]        = { "Box Blur", "Gamma Correction", "Chromatic Aberration" };
    static const char* current_effect_name   = "None";

    if (selected_effect_index >= 0 && selected_effect_index < 3)
    {
    ...
    if (gEnablePostFX && selected_effect_index >= 0 && selected_effect_index < 3)
    {
