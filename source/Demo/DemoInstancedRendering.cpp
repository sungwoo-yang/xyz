...
void DemoInstancedRendering::InitializeSprite(Sprite& sprite)
{
...
void DemoInstancedRendering::ChangeSpriteCount(int new_count)
{
...
void DemoInstancedRendering::Load()
{
    m_Renderer.Init();
...
void DemoInstancedRendering::Unload()
{
    m_Renderer.Shutdown();
}

void DemoInstancedRendering::Draw() const
{
    CS200::RenderingAPI::Clear();
    m_ScreenSize = Engine::GetWindow().GetSize();

    auto& renderer = const_cast<CS200::InstancedRenderer2D&>(m_Renderer);
...
void DemoInstancedRendering::DrawImGui()
{
    if (ImGui::Begin("Demo Controls"))
    {
        ImGui::Text("Renderer: InstancedRenderer2D");
...
gsl::czstring DemoInstancedRendering::GetName() const
{
    return "Demo Instanced Rendering";
}