...
namespace CS200
{
    ...
    {
        m_Shader = OpenGL::CreateShader(std::filesystem::path{ "Assets/shaders/BatchRenderer2D/batch.vert" }, std::filesystem::path{ "Assets/shaders/BatchRenderer2D/batch.frag" });
